...
if (vis) {
  ...
  expectTypeOf(vis.light.preview).toEqualTypeOf<PIXI.LegacyGraphics>();
  expectTypeOf(vis.light.global.source).toEqualTypeOf<PIXI.LegacyGraphics>();
  expectTypeOf(vis.light.global.meshes).toEqualTypeOf<PIXI.Container>();
  expectTypeOf(vis.light.sources).toEqualTypeOf<PIXI.LegacyGraphics>();
  expectTypeOf(vis.light.surfaceExposure).toEqualTypeOf<PIXI.LegacyGraphics>();
  expectTypeOf(vis.light.cached).toEqualTypeOf<SpriteMesh>();
  expectTypeOf(vis.light.mask.preview).toEqualTypeOf<PIXI.LegacyGraphics>();
