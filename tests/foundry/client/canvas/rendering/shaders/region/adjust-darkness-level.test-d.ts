...
expectTypeOf(AdjustDarknessLevelRegionShader["_createFragmentShader"]()).toEqualTypeOf<string>();
...
expectTypeOf(IlluminationDarknessLevelRegionShader["_createFragmentShader"]()).toEqualTypeOf<string>();
