...
// The generic fallback sheet for Document sub-types that have no registered sheet.
...
expectTypeOf<
  foundry.applications.sheets.BaseSheet.RenderContext<Item.Implementation>["hasNothing"]
