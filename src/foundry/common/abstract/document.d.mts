...
declare namespace Document {
  ...
  namespace Database {
    ...
    /**
     * The `(Pre|On)(Create|Update)Operation` interfaces all receive `data` or `update` params that have been `#toObject`ed, so instances
     * are restricted out of the array.
     * @internal
     */
     ...
     */
    type OnCreateOperation<BaseOperation extends DatabaseBackend.CreateOperation> = _RestrictToDataObjects<
      BaseOperation,
      "data"
    >;
