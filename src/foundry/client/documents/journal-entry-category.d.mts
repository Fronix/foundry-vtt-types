...
declare namespace JournalEntryCategory {
  ...
  /**
   * The helper type for the return of {@linkcode JournalEntryCategory.create}, returning (a single | an array of) stored
  ...
  type CreateReturn<Data extends MaybeArray<CreateInput>> =
    Data extends Array<CreateInput> ? Array<JournalEntryCategory.Stored> : JournalEntryCategory.Stored | undefined;
  ...
  namespace Database {
    ...
    /**
     * @deprecated The interface passed to {@linkcode JournalEntryCategory._onCreateDocuments}. It will be removed in a future version along with the
     * method it is for.
    ...
    /**
     * @deprecated The interface passed to {@linkcode JournalEntryCategory._onUpdateDocuments}. It will be removed in a future version along with the
     * method it is for.
    ...
    /**
     * @deprecated The interface passed to {@linkcode JournalEntryCategory._onDeleteDocuments}. It will be removed in a future version along with the
     * method it is for.
