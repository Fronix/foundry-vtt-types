...
declare namespace ActorDelta {
  ...
  /**
   * The helper type for the return of {@linkcode ActorDelta.create}, returning (a single | an array of) stored
   * `ActorDelta`s.
   *
  ...
  type CreateReturn<Data extends MaybeArray<CreateInput>> =
    Data extends Array<CreateInput> ? Array<ActorDelta.Stored> : ActorDelta.Stored | undefined;
  ...
  namespace Database {
    ...
    /**
     * @deprecated The interface passed to {@linkcode ActorDelta._onCreateDocuments}. It will be removed in a future version along with the
     * method it is for.
    ...
    /**
     * @deprecated The interface passed to {@linkcode ActorDelta._onUpdateDocuments}. It will be removed in a future version along with the
     * method it is for.
    ...
    /**
     * @deprecated The interface passed to {@linkcode ActorDelta._onDeleteDocuments}. It will be removed in a future version along with the
     * method it is for.
  ...
  /**
   * @deprecated Replaced with {@linkcode ActorDelta.ConfiguredSubType} (will be removed in a future version).
   */
