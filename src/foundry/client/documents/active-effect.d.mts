...
declare namespace ActiveEffect {
  ...
  namespace Database {
    ...
    /**
     * @deprecated The interface passed to {@linkcode ActiveEffect._onCreateDocuments}. It will be removed in a future version along with the
     * method it is for.
    ...
    /**
     * @deprecated The interface passed to {@linkcode ActiveEffect._onUpdateDocuments}. It will be removed in a future version along with the
     * method it is for.
    ...
    /**
     * @deprecated The interface passed to {@linkcode ActiveEffect._onDeleteDocuments}. It will be removed in a future version along with the
     * method it is for.
