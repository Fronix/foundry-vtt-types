...
declare namespace AmbientSoundDocument {
  ...
  /**
   * The helper type for the return of {@linkcode AmbientSoundDocument.create}, returning (a single | an array of) stored
  ...
  type CreateReturn<Data extends MaybeArray<CreateInput>> =
    Data extends Array<CreateInput> ? Array<AmbientSoundDocument.Stored> : AmbientSoundDocument.Stored | undefined;
  ...
  interface Schema extends fields.DataSchema {
    ...
    /**
     * The set of specific Scene Levels on which this AmbientSound is present. An
     * empty set means the sound is present on every Level.
