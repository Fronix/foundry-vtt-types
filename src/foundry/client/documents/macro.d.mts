...
declare namespace Macro {
  ...
  /**
   * The helper type for the return of {@linkcode Macro.create}, returning (a single | an array of) stored
   * `Macro`s.
   *
  ...
  type CreateReturn<Data extends MaybeArray<CreateInput>> =
    Data extends Array<CreateInput> ? Array<Macro.Stored> : Macro.Stored | undefined;
  ...
  namespace Database {
    ...
    /**
     * @deprecated The interface passed to {@linkcode Macro._onCreateDocuments}. It will be removed in a future version along with the
     * method it is for.
    ...
    /**
     * @deprecated The interface passed to {@linkcode Macro._onUpdateDocuments}. It will be removed in a future version along with the
     * method it is for.
    ...
    /**
     * @deprecated The interface passed to {@linkcode Macro._onDeleteDocuments}. It will be removed in a future version along with the
     * method it is for.
  ...
  /**
   * @deprecated Replaced with {@linkcode Macro.ConfiguredSubType} (will be removed in a future version).
   */
  // eslint-disable-next-line @typescript-eslint/no-deprecated
