...
declare namespace JournalEntry {
  ...
  /**
   * The helper type for the return of {@linkcode JournalEntry.create}, returning (a single | an array of) stored
   * `JournalEntry`s.
   *
  ...
  type CreateReturn<Data extends MaybeArray<CreateInput>> =
    Data extends Array<CreateInput> ? Array<JournalEntry.Stored> : JournalEntry.Stored | undefined;
