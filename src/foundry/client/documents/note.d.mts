...
declare namespace NoteDocument {
  ...
  interface Schema extends fields.DataSchema {
    ...
    /**
     * The set of specific Scene Levels on which this Note is present. An empty
     * set means the Note is present on every Level.
  ...
  namespace Database {
    ...
    /**
     * @deprecated The interface passed to {@linkcode NoteDocument._onCreateDocuments}. It will be removed in a future version along with the
     * method it is for.
    ...
    /**
     * @deprecated The interface passed to {@linkcode NoteDocument._onUpdateDocuments}. It will be removed in a future version along with the
     * method it is for.
    ...
    /**
     * @deprecated The interface passed to {@linkcode NoteDocument._onDeleteDocuments}. It will be removed in a future version along with the
     * method it is for.
