...
declare namespace FogExploration {
  ...
  /**
   * The helper type for the return of {@linkcode FogExploration.create}, returning (a single | an array of) stored
   * `FogExploration`s.
   *
  ...
  type CreateReturn<Data extends MaybeArray<CreateInput>> =
    Data extends Array<CreateInput> ? Array<FogExploration.Stored> : FogExploration.Stored | undefined;
