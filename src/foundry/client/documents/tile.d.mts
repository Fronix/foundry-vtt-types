...
declare namespace TileDocument {
  ...
  namespace Database {
    ...
    /**
     * @deprecated The interface passed to {@linkcode TileDocument._onCreateDocuments}. It will be removed in a future version along with the
     * method it is for.
    ...
    /**
     * @deprecated The interface passed to {@linkcode TileDocument._onUpdateDocuments}. It will be removed in a future version along with the
     * method it is for.
    ...
    /**
     * @deprecated The interface passed to {@linkcode TileDocument._onDeleteDocuments}. It will be removed in a future version along with the
     * method it is for.
