...
declare namespace AmbientLightDocument {
  ...
  /**
   * The helper type for the return of {@linkcode AmbientLightDocument.create}, returning (a single | an array of) stored
  ...
  type CreateReturn<Data extends MaybeArray<CreateInput>> =
    Data extends Array<CreateInput> ? Array<AmbientLightDocument.Stored> : AmbientLightDocument.Stored | undefined;
  ...
  namespace Database {
    ...
    /**
     * @deprecated The interface passed to {@linkcode AmbientLightDocument._onCreateDocuments}. It will be removed in a future version along with the
     * method it is for.
    ...
    /**
     * @deprecated The interface passed to {@linkcode AmbientLightDocument._onUpdateDocuments}. It will be removed in a future version along with the
     * method it is for.
    ...
    /**
     * @deprecated The interface passed to {@linkcode AmbientLightDocument._onDeleteDocuments}. It will be removed in a future version along with the
     * method it is for.
...
declare class AmbientLightDocument extends BaseAmbientLight.Internal.CanvasDocument {
   ...
   * @remarks Assigned during {@link AmbientLightDocument.prepareDerivedData | `AmbientLightDocument#prepareDerivedData`}
   * (a {@linkcode ConeShapeData} if the light's angle is less than 360°, otherwise a {@linkcode CircleShapeData}).
   */
