...
declare namespace RegionBehavior {
  ...
  /**
   * The helper type for the return of {@linkcode RegionBehavior.create}, returning (a single | an array of) stored
   * `RegionBehavior`s.
   *
  ...
  type CreateReturn<Data extends MaybeArray<CreateInput>> =
    Data extends Array<CreateInput> ? Array<RegionBehavior.Stored> : RegionBehavior.Stored | undefined;
  ...
  namespace Database {
    ...
    /**
     * @deprecated The interface passed to {@linkcode RegionBehavior._onCreateDocuments}. It will be removed in a future version along with the
     * method it is for.
    ...
    /**
     * @deprecated The interface passed to {@linkcode RegionBehavior._onUpdateDocuments}. It will be removed in a future version along with the
     * method it is for.
    ...
    /**
     * @deprecated The interface passed to {@linkcode RegionBehavior._onDeleteDocuments}. It will be removed in a future version along with the
     * method it is for.
  ...
  /**
   * @deprecated Replaced with {@linkcode RegionBehavior.ConfiguredSubType} (will be removed in a future version).
   */
