...
declare namespace Item {
  ...
  /**
   * The helper type for the return of {@linkcode Item.create}, returning (a single | an array of) stored
   * `Item`s.
   *
  ...
  type CreateReturn<Data extends MaybeArray<CreateInput>> =
    Data extends Array<CreateInput> ? Array<Item.Stored> : Item.Stored | undefined;
  ...
  namespace Database {
    ...
    /**
     * @deprecated The interface passed to {@linkcode Item._onCreateDocuments}. It will be removed in a future version along with the
     * method it is for.
    ...
    /**
     * @deprecated The interface passed to {@linkcode Item._onUpdateDocuments}. It will be removed in a future version along with the
     * method it is for.
    ...
    /**
     * @deprecated The interface passed to {@linkcode Item._onDeleteDocuments}. It will be removed in a future version along with the
     * method it is for.
  ...
  /**
   * @deprecated Replaced with {@linkcode Item.ConfiguredSubType} (will be removed in a future version).
   */
