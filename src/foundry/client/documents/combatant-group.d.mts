...
declare namespace CombatantGroup {
  ...
  /**
   * The helper type for the return of {@linkcode CombatantGroup.create}, returning (a single | an array of) stored
   * `CombatantGroup`s.
   *
  ...
  type CreateReturn<Data extends MaybeArray<CreateInput>> =
    Data extends Array<CreateInput> ? Array<CombatantGroup.Stored> : CombatantGroup.Stored | undefined;
  ...
  namespace Database {
    ...
    /**
     * @deprecated The interface passed to {@linkcode CombatantGroup._onCreateDocuments}. It will be removed in a future version along with the
     * method it is for.
    ...
    /**
     * @deprecated The interface passed to {@linkcode CombatantGroup._onUpdateDocuments}. It will be removed in a future version along with the
     * method it is for.
    ...
    /**
     * @deprecated The interface passed to {@linkcode CombatantGroup._onDeleteDocuments}. It will be removed in a future version along with the
     * method it is for.
  ...
  /**
   * @deprecated Replaced with {@linkcode CombatantGroup.ConfiguredSubType} (will be removed in a future version).
   */
