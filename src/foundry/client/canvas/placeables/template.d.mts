...
declare class MeasuredTemplate extends PlaceableObject<MeasuredTemplateDocument.Implementation> {
  ...
  /**
   * Refresh the visibility of the MeasuredTemplate, the highlight layer, and the ruler.
   */
   ...
   * @remarks "`MeasuredTemplate.getCircleShape` is deprecated. Use `CircleShapeData` instead."
   */
   ...
   * @deprecated since v14, until v16
   * @remarks "`MeasuredTemplate.getConeShape` is deprecated. Use `ConeShapeData` instead."
   */
   ...
   * @deprecated since v14, until v16
   * @remarks "`MeasuredTemplate.getRectShape` is deprecated. Use `RectangleShapeData` instead."
   */
   ...
   * @deprecated since v14, until v16
   * @remarks "`MeasuredTemplate.getRayShape` is deprecated. Use `LineShapeData` instead."
   */
