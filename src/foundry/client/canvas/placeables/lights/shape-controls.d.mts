...
import type AmbientLight from "../light.mjs";
import type { LightingLayer } from "#client/canvas/layers/_module.d.mts";
...
// (`CircleShapeData | ConeShapeData`), but it is omitted here (defaulting to
...
declare namespace AmbientLightShapeControls {
  interface Any extends AnyAmbientLightShapeControls {}
  interface AnyConstructor extends Identity<typeof AnyAmbientLightShapeControls> {}
}

declare abstract class AnyAmbientLightShapeControls extends AmbientLightShapeControls {
